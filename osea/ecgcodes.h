...
#ifndef OSEA_ECGCODES_H
#define OSEA_ECGCODES_H

#define NOTQRS   0   /* not-QRS */
...
#define ACMAX    49  /* value of largest valid annot code */

/* Human-readable labels */
static const char *ANNOTYPE_LABELS[] = {
    "NOTQRS", "NORMAL", "LBBB", "RBBB", "ABERR", "PVC", "FUSION",
    "NPC", "APC", "SVPB", "VESC", "NESC", "PACE", "UNKNOWN",
    "NOISE", NULL, "ARFCT", NULL, "STCH", "TCH", "SYSTOLE",
    "DIASTOLE", "NOTE", "MEASURE", NULL, "BBB", "PACESP",
    NULL, "RHYTHM", NULL, "LEARN"
};
